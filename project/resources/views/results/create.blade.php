...
@section('content')
    <div><h1 class="mb-3 mt-3">@lang('messages.add_result')</h1></div>
    <hr>
    ...
    <div class="form-group">
        ...
        {{Form::Number('result_1', '', ['class' => 'form-control', 'placeholder' => __('messages.result')])}}
    </div>
    <div class="form-group">
        {{Form::label('result_2', __('messages.result_second'))}}
        {{Form::Number('result_2', '', ['class' => 'form-control', 'placeholder' => __('messages.result')])}}
    </div>
    <div class="form-group">
